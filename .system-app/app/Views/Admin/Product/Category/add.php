                        		...
                        		<div class="card-body">
                                    ...
                                    <form action="" method="POST">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" autocomplete="off" name="category" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label class="col-form-label col-md-4">Urutan</label>
                                            <div class="col-md-8">
                                                <input type="number" class="form-control" autocomplete="off" name="sort" autocomplete="off">
                                            </div>
                                        </div>
