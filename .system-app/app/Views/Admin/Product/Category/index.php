                        					...
                        					<tbody>
                        						...
                        						<tr>
                        							...
                        							<td style="width: 10;white-space: nowrap;">
                                                        <a href="<?= base_url(); ?>/admin/product/category/edit/<?= $category['id']; ?>" class="btn btn-sm btn-primary">Edit</a>
                        								<button onclick="hapus('<?= base_url(); ?>/admin/product/category/delete/<?= $category['id']; ?>');" class="btn btn-sm btn-danger">Hapus</button>
                        							</td>
                        						</tr>
                                                <?php endforeach ?>
                        					</tbody>
