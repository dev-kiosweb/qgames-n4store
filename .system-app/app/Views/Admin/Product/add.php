                        		...
                        		<div class="card-body">
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" autocomplete="off" name="product" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="number" class="form-control mb-2" autocomplete="off" name="price">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="check-kostum">
                                                    <label class="form-check-label" for="check-kostum">Kostum Harga</label>
                                                </div>
                                                <div class="mb-3 mt-3 hide" id="kostum-price">
                                                    <?php foreach ($methods as $method): ?>
                                                    <div class="row mb-3">
                                                        <div class="col-5">
                                                            <img src="<?= $method['images']; ?>" alt="" width="100" class="mt-2">
                                                        </div>
                                                        <div class="col-7">
                                                            <input type="hidden" name="c_method_id[]" value="<?= $method['id']; ?>">
                                                            <input type="number" class="form-control" autocomplete="off" placeholder="Harga" name="c_price[]">
                                                        </div>
                                                    </div>
                                                    <?php endforeach ?>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" autocomplete="off" name="sku" autocomplete="off">
                                            </div>
                                        </div>
