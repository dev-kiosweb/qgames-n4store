                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <img src="<?= base_url(); ?>/assets/images/games/<?= $games['images']; ?>" width="120" class="rounded mb-3">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <select name="target" class="form-control">
                                                    ...
                                                    <option value="C" <?= $games['target'] == 'C' ? 'selected' : ''; ?>>2 Target (ID Player / Server) - Genshin Impact</option>
                                                    <option value="D" <?= $games['target'] == 'D' ? 'selected' : ''; ?>>2 Target (ID Player / Server) - LifeAfter</option>
                                                    <option value="E" <?= $games['target'] == 'E' ? 'selected' : ''; ?>>2 Target (ID Player / Server) - Ragnarok</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
