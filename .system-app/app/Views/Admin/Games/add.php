                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-8">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Tambah Games</h5>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <select name="target" class="form-control">
                                                    ...
                                                    <option value="C">2 Target (ID Player / Server) - Genshin Impact</option>
                                                    <option value="D">2 Target (ID Player / Server) - LifeAfter</option>
                                                    <option value="E">2 Target (ID Player / Server) - Ragnarok</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
