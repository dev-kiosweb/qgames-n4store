                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10">
                        	<div class="card">
                        		<div class="card-body">
                        			<h5 class="card-title">Kelola Games</h5>
                        			<div class="mb-3">
                        					...
                        					<tbody>
                        						...
                        						<tr>
                        							...
                        							<td style="width: 10;white-space: nowrap;">
                        								<a href="<?= base_url(); ?>/admin/games/edit/<?= $games['id']; ?>" class="btn btn-sm btn-primary">Edit</a>
                        								<button onclick="hapus('<?= base_url(); ?>/admin/games/delete/<?= $games['id']; ?>');" class="btn btn-sm btn-danger">Hapus</button>
                        							</td>
                        						</tr>
                                                <?php endforeach ?>
                        					</tbody>
