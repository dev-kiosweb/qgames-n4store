                                        ...
                                        <table class="table border table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 10;white-space: nowrap;">
                                                    <button onclick="edit('<?= $faq['id']; ?>');" class="btn btn-sm btn-primary">Edit</button>
                                                    <button onclick="hapus('<?= base_url(); ?>/admin/page/faq/delete/<?= $faq['id']; ?>');" class="btn btn-sm btn-danger">Hapus</button>
                                                </td>
                                            </tr>
                                            <?php endforeach ?>
                                            <?php if (count($faqs) == 0): ?>
                            ...
                            <div class="modal-content">
                                ...
                                <form action="" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary" name="tombol" value="submit">Tambah</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                        <button type="submit" class="btn btn-primary" name="edit" value="submit">Simpan</button>
                                    </div>
                                </form>
                            </div>
                        </div>
